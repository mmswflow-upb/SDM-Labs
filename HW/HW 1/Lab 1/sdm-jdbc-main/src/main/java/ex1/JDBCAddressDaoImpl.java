...
public class JDBCAddressDaoImpl extends CoreJDBCDao implements AddressDAO{
    ...
    public Set<Address> findAll() {
        ...
        try (
            ...
            while (rs.next()){
                Address ad=new Address(rs.getInt("id"),rs.getString("city"),rs.getString("street"), rs.getString("country"));
                addresses.add(ad);
            }
    ...
    public Set<Address> findByCity(String city) {
        ...
        try (PreparedStatement findByCityStmt = connection.prepareStatement(findByCitySQL)) {
            ...
            while (rs.next()) {
                Address address = new Address(rs.getInt("id"), rs.getString("city"), rs.getString("street"), rs.getString("country"));
    ...
    public Address insert(Address address) {
        ...
        String insertAddressSQL = "INSERT into addresses(city,street, country) values(?,?,?)";
        try (
